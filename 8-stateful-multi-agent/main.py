...
initial_state = {
    "user_name": "Ashutosh Choudhari", # In a real app, this would come from your auth system
    "purchased_courses": [],
    "interaction_history": [],
}
...
async def main_async():
    ...
    USER_ID = "aiwithashutosh" # In a real app, this would come from your auth system
